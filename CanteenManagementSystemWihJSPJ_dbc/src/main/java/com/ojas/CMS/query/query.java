...
public interface query {
	 ...
	 */
   public static final String LOGINUSE="SELECT rname FROM cms.roles WHERE rid = (SELECT rid FROM cms.users u WHERE u.uname=? AND u.pass=?)";
   ...
   // admin vendor 
   public static final String ADDVENDOR="INSERT INTO vendor(vname,email,mobile,address) VALUES(?,?,?,?)";
